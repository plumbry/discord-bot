...
const { forEachGuildMemberPage } = require("./guildMemberList");
...
async function finishSignupRoleAssignment(
  ...
  if (skipSignupReactions) {
    rulesAckNote =
      "\nSignup reactions: skipped (bulk untagged list).";
  } else if (acknowledgementMessages !== null) {
